...
Copy-Command "gptpro-plan.md" (Join-Path $ccgNamespace "gptpro-plan.md")
Copy-Command "gptpro-review.md" (Join-Path $ccgNamespace "gptpro-review.md")
Copy-Command "gptpro-exc.md" (Join-Path $ccgNamespace "gptpro-exc.md")
