...
foreach ($commandName in @("ccg.md", "plan.md", "execute.md", "gemini-preview.md", "verify-change.md")) {
...
foreach ($skillName in @("ccg-plan", "ccg-execute", "ccg-gemini-preview", "verify-change")) {
...
foreach ($skill in @("ccg:plan", "ccg:execute", "ccg:gemini-preview", "ccg:verify-change")) {
